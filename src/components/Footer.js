      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-purple-100">Unlocking celestial wisdom for your life's journey.</p>
            {/* <div className="flex space-x-4">
              <a href="#" className="text-purple-200 hover:text-white transition transform hover:scale-110">
